import {Context, inject, intercept} from '@loopback/core';
...
export class UserController {
  ...
  constructor(
    ...
    // this.add(createBindingFromClass(NameconvetorInterceptor))
  }
  ...
  @intercept('check-interceptor') // `caching-interceptor` is a binding key
